        ...
        <SafeAreaView>
            <View className="h-full w-full">
                <View className="w-full h-14 flex justify-between items-center flex-row border-b border-gray-300">
                    ...
                    <View className="h-full w-36 flex-row items-center justify-around">
                        <Ionicons name="person-outline" size={26} />
                        <TouchableOpacity className="w-16 h-8 border border-gray-300 flex items-center justify-center rounded">
                            <Text>Login</Text>
                        </TouchableOpacity>
                    </View>
                </View>
                <View className="w-full h-2/3 flex items-center justify-center mt-10">
                    <View className="w-80 h-3/5 flex-column items-center justify-around">
                        <View className="flex items-center justify-between h-2/3 w-full">
                            <View className="w-24 h-24 bg-teal-400 rounded-full flex items-center justify-center">
                        ...
                        <TouchableOpacity onPress={() => {navigation.navigate("Login" as never)}} className="w-48 h-12 bg-teal-600 flex items-center justify-center rounded">
