...
const NewPassword = () => {
    ...
    return (
        <SafeAreaView className="items-center">
            ...
            <TouchableOpacity onPress={() => {navigation.navigate('Bottom' as never)}} className="w-11/12 h-11 rounded bg-indigo-950 shadow shadow-sky-700 flex items-center justify-center mt-6">
